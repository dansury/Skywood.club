...
- Каталог: карточки товаров (галерея фото — точки-индикаторы; свайп влево/вправо
  на тач-устройствах; перелистывание по горизонтальной позиции курсора при
  наведении на десктопе, возврат к первому фото при уходе курсора), модалка
  товара (галерея — миниатюры, стрелки, свайп, клавиши ←/→).
